...
import { teachersData, calendarEvents } from "@/lib/mockData";
import { ArrowLeft, Calendar, Clock, ChevronLeft, ChevronRight, School } from "lucide-react";
...
const MOCK_TIMETABLE: Record<string, Record<string, { subject: string; class: string; room: string } | null>> = {
  Monday: {
    "08:00 - 08:45": { subject: "Math", class: "1B", room: "101" },
    "09:00 - 09:45": { subject: "Math", class: "2A", room: "102" },
    "10:00 - 10:45": null,
    "11:00 - 11:45": { subject: "Geometry", class: "3C", room: "103" },
    "12:00 - 12:45": null,
    "13:00 - 13:45": { subject: "Math", class: "1B", room: "101" },
    "14:00 - 14:45": null,
    "15:00 - 15:45": null,
  },
  Tuesday: {
    "08:00 - 08:45": { subject: "Geometry", class: "3C", room: "103" },
    "09:00 - 09:45": { subject: "Math", class: "2A", room: "102" },
    "10:00 - 10:45": { subject: "Math", class: "1B", room: "101" },
    "11:00 - 11:45": null,
    "12:00 - 12:45": null,
    "13:00 - 13:45": null,
    "14:00 - 14:45": { subject: "Math", class: "2A", room: "102" },
    "15:00 - 15:45": null,
  },
  Wednesday: {
    "08:00 - 08:45": null,
    "09:00 - 09:45": { subject: "Math", class: "1B", room: "101" },
    "10:00 - 10:45": { subject: "Geometry", class: "3C", room: "103" },
    "11:00 - 11:45": { subject: "Math", class: "2A", room: "102" },
    "12:00 - 12:45": null,
    "13:00 - 13:45": { subject: "Geometry", class: "3C", room: "103" },
    "14:00 - 14:45": null,
    "15:00 - 15:45": null,
  },
  Thursday: {
    "08:00 - 08:45": { subject: "Math", class: "2A", room: "102" },
    "09:00 - 09:45": null,
    "10:00 - 10:45": { subject: "Math", class: "1B", room: "101" },
    "11:00 - 11:45": { subject: "Geometry", class: "3C", room: "103" },
    "12:00 - 12:45": null,
    "13:00 - 13:45": null,
    "14:00 - 14:45": { subject: "Math", class: "1B", room: "101" },
    "15:00 - 15:45": { subject: "Geometry", class: "3C", room: "103" },
  },
  Friday: {
    "08:00 - 08:45": { subject: "Geometry", class: "3C", room: "103" },
    "09:00 - 09:45": { subject: "Math", class: "1B", room: "101" },
    ...
    "11:00 - 11:45": null,
    "12:00 - 12:45": null,
    "13:00 - 13:45": { subject: "Math", class: "2A", room: "102" },
    "14:00 - 14:45": null,
    "15:00 - 15:45": null,
  },
};
...
export default function TeacherTimetablePage() {
  ...
  const [selectedDay, setSelectedDay] = useState<string>(DAYS[new Date().getDay() - 1] || DAYS[0]);
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">{teacher.name} • {totalClasses} classes per week</p>
            </div>
          </div>
        </div>
      </div>
